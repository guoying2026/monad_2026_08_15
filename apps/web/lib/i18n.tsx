...
const dict = {
  zh: {
    ...
    poolMembers: "已盯这个盘",
    poolJoined: "{n} 人",
    notifyTip: "填邮箱或 Telegram，也可以两个都填。",
    emailLabel: "邮箱",
    emailPlaceholder: "you@email.com",
    telegram: "Telegram chatId",
    telegramHint: "先打开 t.me/monad_gy_bot 点 Start，再填你的 chatId",
    viewHistory: "查看历史通知",
  ...
  en: {
    ...
    notifyTip: "Enter email, Telegram, or both.",
    emailLabel: "Email",
    emailPlaceholder: "you@email.com",
    telegram: "Telegram chatId",
    telegramHint: "Open t.me/monad_gy_bot, tap Start, then paste your chatId",
