...
const dict = {
  zh: {
    ...
    homeLead:
      "选一个 Polymarket 事件，付 $0.01 USDC。订阅后立刻扫一轮，之后每 5 分钟看过去 5 分钟的 YES 变动，对照新闻、社交和盘口资金，用 Telegram 推到你留下的 chatId。",
    homeCtaScan: "付 $0.01 开始盯盘",
    cardIdentity: "身份",
    cardIdentityBody: "链上 ERC-721 Agent。可被发现、可转让，指向 HTTP 接口和收款钱包。",
    cardPayment: "付款",
    cardPaymentBody: "盯一个事件 $0.01，经 x402 在 Monad 收 USDC。通知发到这条订阅里的 Telegram。",
    cardWatch: "盯盘",
    ...
    poolMembers: "已盯这个盘",
    poolJoined: "{n} 人",
    notifyTip: "填 Telegram chatId。波动通知只发到这个号。",
    emailLabel: "邮箱",
    ...
    errEmail: "请填写有效邮箱。",
    errChannelNone: "请填写 Telegram chatId。",
    ...
    paymentNoTx: "还没有链上交易。",
    paymentNeedUsdc: "可补付 $0.01。",
    paymentFaucet: "打开水龙头",
    paymentRetry: "补付 $0.01",
    paymentRetrying: "付款中…",
    paymentOpenTx: "查看链上详情",
    paymentWallet: "钱包",
    paymentTx: "交易哈希",
    useful: "有用",
    inaccurate: "不准",
    ...
    alertHistory: "通知历史",
    watchingTitle: "正在盯的盘",
    watchingEmpty: "还没有订阅。先到「选择想要关注的 Polymarket 事件」选一个盘。",
    watchingChannel: "渠道",
    watchingNone: "仅结果页",
    checkSwing: "检查波动",
    checkingSwing: "检查中…",
  ...
  en: {
    navAgent: "Home",
    navScan: "Choose a Polymarket event",
    navAlerts: "Account",
    ...
    homeLead:
      "Pick a Polymarket event and pay $0.01 USDC. The first scan runs immediately. Every 5 minutes Pulse checks the last 5 minutes of YES, reads news, social, and book flow, then Telegrams the chatId on that subscription.",
    ...
    cardPayment: "Payment",
    cardPaymentBody: "Watch one event for $0.01 via x402 USDC on Monad. Alerts go to the Telegram on that subscription.",
    cardWatch: "Watch",
    ...
    notifyTip: "Enter your Telegram chatId. Alerts go only to that account.",
    emailLabel: "Email",
    emailPlaceholder: "you@email.com",
    ...
    errChannelNone: "Enter a Telegram chatId.",
    ...
    paymentNoTx: "No on-chain transaction yet.",
    paymentNeedUsdc: "You can pay $0.01 now.",
    paymentFaucet: "Open faucet",
    ...
    watchingEmpty: "No subscriptions yet. Pick a market under Choose a Polymarket event.",
