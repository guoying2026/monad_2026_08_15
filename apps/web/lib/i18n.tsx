...
const dict = {
  zh: {
    ...
    poolMembers: "已盯这个盘",
    poolJoined: "{n} 人",
    notifyTip: "推送渠道二选一：填邮箱或 Telegram，不要两个都填。",
    emailLabel: "邮箱",
    ...
    errEmail: "请填写有效邮箱。",
    errChannelBoth: "邮箱和 Telegram 只能填一个。",
    errChannelNone: "请填写邮箱或 Telegram。",
  ...
  en: {
    ...
    notifyTip: "Pick one channel: email or Telegram, not both.",
    emailLabel: "Email",
    emailPlaceholder: "you@email.com",
    telegram: "Telegram chatId",
    ...
    errChannelBoth: "Use email or Telegram, not both.",
    errChannelNone: "Enter an email or a Telegram chatId.",
