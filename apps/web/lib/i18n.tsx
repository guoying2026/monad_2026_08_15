...
const dict = {
  zh: {
    ...
    cardPayment: "付款",
    cardPaymentBody: "扫盘和盯盘都是 $0.01。x402 在 Monad 收 USDC，一口价，不用算账。",
    cardWatch: "盯盘",
  ...
  en: {
    ...
    cardPayment: "Payment",
    cardPaymentBody: "Scan and watch are both $0.01. x402 USDC on Monad. One price, no spreadsheet.",
    cardWatch: "Watch",
    ...
    settling: "Settling…",
    payScan: "Pay for a personal report",
    connectThenScan: "Connect, then pay & scan",
    opening: "Joining…",
    ...
    noReport: "No report yet. Run a paid scan first.",
